  ...
  return (
    <div className="min-h-screen bg-muted/30 bg-doodle pt-16">
      <div className="max-w-2xl lg:max-w-5xl mx-auto px-4 py-8">
        ...
        {/* Mobile: summary stacked above form · Desktop: form left, summary right */}
        <div className="flex flex-col gap-6 lg:grid lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start">

          {/* Trip summary chip */}
          <div className="lg:order-2 lg:sticky lg:top-24 bg-card border border-border rounded-xl p-4 flex flex-col sm:flex-row sm:items-center lg:flex-col lg:items-stretch gap-3">
            ...
            <div className="shrink-0 text-right lg:text-left lg:border-t lg:border-border lg:pt-3">
              <p className="text-sm font-medium text-foreground">{fmt12(bus.departureTime)}</p>
              <div className="flex items-center gap-1.5 mt-1 justify-end lg:justify-start flex-wrap">
                {seats.map((s) => (
          ...
          {/* Form card */}
          <div className="lg:order-1 bg-card border border-border rounded-xl p-6 lg:p-8 space-y-5">
            <div>
            ...
            {/* Boarding + dropping — side by side on wider screens */}
            <div className="grid sm:grid-cols-2 gap-5">
              {/* Boarding point */}
              <div>
                <label className="block text-sm font-medium text-foreground mb-1.5">
