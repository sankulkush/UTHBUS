...
export default function BusCard({ bus, onBook, viewMode = 'list', bookedSeats, currentUser, searchDate }: BusCardProps) {
        ...
        <div className="min-h-[600px] md:min-h-[600px] flex flex-col">
          ...
          <div className="flex-1 p-4 md:p-6 pb-0">
              ...
              <div>
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 xl:gap-2">
                  ...
                  <div className="flex justify-center xl:justify-start">
                    <div className="bg-card border border-border rounded-xl shadow-soft p-3 sm:p-4 w-full max-w-sm xl:max-w-none">
                      <div className="bg-muted rounded-xl p-2 sm:p-3">
                        ...
                        <div className="bg-card rounded-xl p-2 sm:p-3 border-2 border-dashed border-border">
                                ...
                                {row.map((seat, colIndex) => (
                                  <div key={seat?.number || `aisle-${colIndex}`} className="flex items-center">
                                    {seat ? (
                                      <button
                                        ...
                                        className={`w-8 h-8 sm:w-10 sm:h-10 rounded border text-xs font-bold transition-all flex items-center justify-center shadow-sm ${
                                          selectedSeats.includes(seat.number)
                                            ...
                                            : seat.available
                                            ? 'bg-card border-border text-foreground hover:border-green-400 hover:shadow-md'
                                      ...
                                      <div className="w-4 h-8 sm:w-6 sm:h-10 bg-muted rounded opacity-50"></div>
                                    )}
                                  </div>
                                ))}
                              </div>
                  ...
                  <div className="hidden xl:block xl:col-span-2">
                    <div className="bg-card border border-border rounded-xl shadow-soft p-4 sm:p-6">
                      <div className="mb-4 sm:mb-6">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                          <h2 className="text-lg sm:text-xl font-bold text-foreground">{bus.name}</h2>
                        </div>
                      </div>
                      <div className="mb-4 sm:mb-6">
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3 rounded-xl overflow-hidden">
                          <div className="bg-muted border-2 border-dashed border-border p-3 sm:p-6 flex items-center justify-center text-muted-foreground rounded-xl">
                            ...
                            {bus.amenities.map((amenity, index) => {
                              ...
                              return (
                                <div key={index} className="flex items-center gap-2 sm:gap-3">
                                  ...
                                  <span className="text-foreground text-xs sm:text-sm">{amenity}</span>
                                </div>
                              );
                            })}
                          </div>
                  ...
                  <div className="xl:hidden">
                    <button
                      ...
                      className="w-full bg-card border border-border rounded-xl shadow-soft p-4 flex items-center justify-between"
                    >
                    ...
                    {showBusDetails && (
                      <div className="mt-4 bg-card border border-border rounded-xl shadow-soft p-4">
                        <div className="mb-4">
                          <h2 className="text-lg font-bold text-foreground mb-4">{bus.name}</h2>
                          <div className="grid grid-cols-2 gap-2 rounded-xl overflow-hidden mb-4">
                            <div className="bg-muted border-2 border-dashed border-border p-4 flex items-center justify-center text-muted-foreground rounded-xl">
                              <div className="text-center">
            ...
            {currentStep === 'details' && (
              <div>
                <div className="text-center mb-6">
                  <h3 className="text-lg sm:text-xl font-bold text-foreground mb-2">Passenger Details</h3>
                  <p className="text-sm text-muted-foreground">Enter passenger information for seat {selectedSeats[0]}</p>
                  {currentUser && (
                ...
                <div className="bg-card border border-border rounded-xl shadow-soft p-4 sm:p-6 max-w-4xl mx-auto">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-3 border border-input bg-background rounded-xl focus:ring-2 focus:ring-ring focus:border-ring text-sm sm:text-base text-foreground placeholder:text-muted-foreground/60 transition-all"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border border-input bg-background rounded-xl focus:ring-2 focus:ring-ring focus:border-ring text-sm sm:text-base text-foreground placeholder:text-muted-foreground/60 transition-all"
            ...
            {currentStep === 'confirmation' && (
              <div>
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-foreground mb-2">Review & Pay</h3>
                  <p className="text-sm text-muted-foreground">Please review your booking details</p>
                </div>
                
                <div className="bg-card border border-border rounded-xl shadow-soft p-4 sm:p-6 max-w-4xl mx-auto">
                  <div className="bg-muted/40 rounded-xl p-4 sm:p-6 space-y-4">
                    <div className="flex items-center gap-3 sm:gap-4">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary/10 rounded-xl flex items-center justify-center flex-shrink-0">
                        <MapPin className="w-5 h-5 sm:w-6 sm:h-6 text-primary" />
                      </div>
                      <div className="min-w-0 flex-1">
                        <h4 className="font-medium text-foreground truncate">{bus.name}</h4>
                        <p className="text-sm text-muted-foreground truncate">{bus.startPoint} → {bus.endPoint}</p>
                        <p className="text-xs text-muted-foreground/70">Travel Date: {new Date(travelDate).toLocaleDateString()}</p>
                      </div>
                    </div>
                    ...
                    <div className="border-t pt-4 space-y-2">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-sm font-medium truncate ml-2 text-foreground">{passengerName}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-muted-foreground">Phone:</span>
                        <span className="text-sm font-medium text-foreground">{passengerPhone}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-muted-foreground">Seat:</span>
                        <span className="text-sm font-medium text-foreground">{selectedSeats[0]}</span>
                      </div>
                      {boardingPoint && (
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-muted-foreground">Boarding:</span>
                          <span className="text-sm font-medium truncate ml-2 text-foreground">{boardingPoint}</span>
                        </div>
                      )}
                      {droppingPoint && (
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-muted-foreground">Dropping:</span>
                          <span className="text-sm font-medium truncate ml-2 text-foreground">{droppingPoint}</span>
                        </div>
                      )}
                      {currentUser && (
                        <div className="flex justify-between items-center bg-green-500/10 -mx-2 px-2 py-1 rounded">
                          <span className="text-sm text-green-600 dark:text-green-400">Account:</span>
                          <span className="text-sm font-medium text-green-600 dark:text-green-400 truncate ml-2">✓ Linked to {currentUser.email}</span>
                        </div>
                      )}
                      <div className="flex justify-between items-center text-base sm:text-lg font-semibold border-t pt-2 mt-3">
                        <span>Total:</span>
                        <span className="text-primary">रु {bus.price}</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-center space-x-2 md:space-x-8 overflow-x-auto">
                {['seats', 'details', 'confirmation'].map((step, index) => (
                  <div key={step} className="flex items-center flex-shrink-0">
                    ...
                    {index < 2 && <div className="w-4 md:w-12 h-px bg-border mx-1 md:mx-4"></div>}
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 p-4">
              ...
              <div className="flex items-center justify-center md:justify-end gap-2 md:gap-3">
                <button
                  ...
                  className="px-4 md:px-6 py-2 text-sm md:text-base text-foreground border border-border rounded-xl hover:bg-muted/60 transition-colors"
                >
                  Close
                </button>
                ...
                {currentStep === 'confirmation' ? (
                  <button
                    ...
                    disabled={loading}
                    className="flex items-center gap-2 bg-primary hover:bg-primary/90 disabled:opacity-50 text-primary-foreground px-4 md:px-6 py-2 rounded-xl font-medium transition-colors text-sm md:text-base"
                  >
                    {loading ? (
                      <>
                  ...
                  <button
                    ...
                    className="bg-primary hover:bg-primary/90 disabled:opacity-50 text-primary-foreground px-4 md:px-6 py-2 rounded-xl font-medium transition-colors text-sm md:text-base"
                  >
                    Continue
                  </button>
                )}
  ...
  return (
    <div ref={cardRef} className="bg-card rounded-xl border border-border hover:shadow-soft-md transition-all duration-300 overflow-hidden">
      {/* Main Bus Card */}
      <div 
      ...
      >
        ...
        <div className="block md:hidden">
          <div className="flex items-start justify-between mb-3">
            <div className="flex-1 min-w-0 pr-2">
              ...
              <div className="inline-flex items-center space-x-1 text-base font-semibold text-foreground">
            ...
            <div className="text-right flex-shrink-0">
              <div className="text-lg font-bold text-primary">रु {bus.price}</div>
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="text-center flex-shrink-0">
              <div className="text-base font-semibold text-foreground">{formatTime(bus.departureTime)}</div>
              <div className="text-xs text-muted-foreground truncate w-25">{bus.startPoint}</div>
            </div>
            
            <div className="flex flex-col items-center gap-1 flex-1 mx-2">
              <div className="text-xs text-muted-foreground">{calculateDuration(bus.departureTime, bus.arrivalTime)}</div>
            ...
            <div className="text-center flex-shrink-0">
              <div className="text-base font-semibold text-foreground">{formatTime(bus.arrivalTime)}</div>
              <div className="text-xs text-muted-foreground truncate w-25">{bus.endPoint}</div>
            </div>
          </div>
        ...
        <div className="hidden md:flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            <div className="text-center">
              <div className="text-xl font-semibold text-foreground">{formatTime(bus.departureTime)}</div>
              <div className="text-sm text-muted-foreground">{bus.startPoint}</div>
            </div>

            <div className="flex flex-col items-center gap-1">
              <div className="text-sm text-muted-foreground">{calculateDuration(bus.departureTime, bus.arrivalTime)}</div>
              <div className="w-20 h-px bg-border"></div>
              <Clock className="w-4 h-4 text-muted-foreground" />
            </div>

            <div className="text-center">
              <div className="text-xl font-semibold text-foreground">{formatTime(bus.arrivalTime)}</div>
              <div className="text-sm text-muted-foreground">{bus.endPoint}</div>
            </div>
            
            <div className="text-center">
              <div className="text-2xl font-bold text-primary">रु {bus.price}</div>
              <div className="flex items-center gap-2 mt-2">
                <span className="text-sm text-primary">View seats</span>
